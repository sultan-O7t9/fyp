...
const DataBody = props => {
  ...
  return (
    <>
      ...
      <TableRow>
        <TableCell>Domain Model</TableCell>
        <TableCell>2</TableCell>
        <TableCell>
          {evalData.students && evalData.students.length
            ? evalData.students.map(student => {
      ...
      <TableRow>
        <TableCell>Class Diagram</TableCell>
        <TableCell>2</TableCell>
        <TableCell>
          {evalData.students && evalData.students.length
            ? evalData.students.map(student => (
      ...
      <TableRow>
        <TableCell>Sequence Diagram</TableCell>
        <TableCell>2</TableCell>
        <TableCell>
          {evalData.students && evalData.students.length
            ? evalData.students.map(student => (
      ...
      <TableRow>
        <TableCell>State Chart Diagram</TableCell>
        <TableCell>2</TableCell>
        <TableCell>
          {evalData.students && evalData.students.length
            ? evalData.students.map(student => (
      ...
      <TableRow>
        <TableCell>Collaboration Diagram</TableCell>
        <TableCell>2</TableCell>
        <TableCell>
          {evalData.students && evalData.students.length
            ? evalData.students.map(student => (
